...
| CLI          | JSON-first `a3s-flow` commands for node discovery plus file CRUD: `create`, `read`, `update`, `delete`, `validate`, `compile`, and `digest`; writes are atomic, updates support batch patches/dry-run, and all candidates are revalidated                                                                                                                                 |
