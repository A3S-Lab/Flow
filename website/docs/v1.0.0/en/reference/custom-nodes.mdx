  ...
  manifest: {
    ...
    fields: [
      ...
      },
      {
        ...
        info: 'Stop when required order fields are missing.',
        type: 'bool',
...
`validateA3SFlowDagNodeConfiguration` first compiles the generated A3S UI form and validates the value against its plan. Built-in nodes then receive their additional Flow semantic checks. Custom nodes receive the same form compiler and value validation without pretending that Flow knows the host service's business rules.
