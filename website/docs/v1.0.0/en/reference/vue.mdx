...
Custom nodes use the same `registry` input as built-in nodes. Build the catalog and require its executor bindings as described in the [custom node guide](./custom-nodes).
