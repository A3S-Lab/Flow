/* @ts-self-types="./a3s_flow_playground_kernel.d.ts" */
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./a3s_flow_playground_kernel_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('a3s_flow_playground_kernel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
