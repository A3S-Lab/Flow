    ...
    case "flow.start":
      return [
        item(
          "workflow",
          copy.workflow,
          stringValue(data.workflow_name) ?? copy.notSet,
        ),
      ];
    case "flow.condition":
      return [
    ...
    case "flow.complete":
      return [
        item(
          "output",
          copy.output,
          expressionValue(data.output_expression, "output", chinese) ??
            copy.notSet,
        ),
      ];
    case "flow.fail":
      return [
        item(
          "message",
          copy.message,
          expressionValue(data.error_expression, "error", chinese) ??
            copy.notSet,
        ),
      ];
    case "flow.step":
      return [
        item(
          "handler",
          copy.handler,
          stringValue(data.step_name) ?? copy.notSet,
        ),
      ];
    case "flow.batch": {
      const steps = Array.isArray(data.steps) ? data.steps : [];
      return [item("steps", copy.steps, String(steps.length))];
    }
    case "flow.wait":
      return [
        item(
      ...
      return [
        item(
          ...
          stringValue(data.subject) ??
            callbackKind(data.kind, chinese) ??
            copy.notSet,
        ),
      ];
    case "flow.cancel":
    ...
    case "flow.continue-as-new":
      return [
        item(
          "input",
          copy.input,
          expressionValue(data.input, "input", chinese) ?? copy.notSet,
        ),
      ];
    case "flow.progress":
      return [
        item(
          "progress",
          copy.progress,
          stringValue(data.progress_id) ?? copy.notSet,
        ),
      ];
    case "flow.child-operation":
      return [
        item(
          "reference",
          copy.reference,
          stringValue(data.reference_id) ?? copy.notSet,
        ),
      ];
    case "flow.child-workflow":
      return [
        item(
          "workflow",
          copy.workflow,
          workflowReference(data.spec) ?? copy.notSet,
        ),
      ];
    case "flow.child-workflows": {
      const children = Array.isArray(data.children) ? data.children : [];
      return [item("children", copy.children, String(children.length))];
    }
    case "flow.signal":
      return [
        item(
          "signal",
          copy.signal,
          stringValue(data.signal_name) ?? copy.notSet,
        ),
      ];
    case "iteration":
      return [
        item(
          "items",
          copy.items,
          expressionValue(data.items, "input", chinese) ?? copy.notSet,
        ),
      ];
    case "loop":
      return [
