import { analyzeExpression } from '@a3s-lab/ui/form/core';
  ...
  node('control-flow', 'Control flow', {
    ...
    fields: [
      ...
      },
      {
        ...
        info: 'Names the true branch on the canvas. Connected edge labels update immediately while the stable port ID remains matched.',
        type: 'str',
        _input_type: 'StrInput',
        value: 'Matched',
        required: true,
      ...
      },
      {
        ...
        info: 'Names the fallback branch on the canvas. Connected edge labels update immediately while the stable port ID remains otherwise.',
        type: 'str',
        _input_type: 'StrInput',
        value: 'Otherwise',
        required: true,
