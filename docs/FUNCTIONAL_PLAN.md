...
3. **Production storage and task management**
   ...
   - Keep runtime-build admission fail closed across start, replay, wait, hook,
     cancellation, scheduler, Boot, and FlowWorker paths. Preserve exact-route
