...
3. **Production storage and task management**
   ...
   - Keep continue-as-new predecessor links authoritative and successor creation
     ...
     and hop-limit guards, linked retention, and SQL hook/wakeup cleanup.
