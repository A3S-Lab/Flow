...
5. **Workflow authoring ergonomics**
   - Keep the 18 public node manifests, six authoring groups, configuration
     ...
     snapshot), registry-driven container parent placement, optimistic base-digest checks, and Skill instructions aligned with the
